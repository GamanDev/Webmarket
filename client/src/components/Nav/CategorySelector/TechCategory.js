...
import { techProducts } from "../../../utils/gql/techProducts";
...
class TechCategory extends Component {
  ...
  componentDidMount() {
    if (this.state.isMounted) {
      dataFetching(this.props, techProducts).then((result) =>
        this.setState({
          ...this.state,
...
export default withRouter(TechCategory);
